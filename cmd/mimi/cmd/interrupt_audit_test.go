...
var interruptAudit = []auditEntry{
	...
	audited(
		"action unminimize_window",
		interruptRunsOn,
		"as resize_window; an Accessibility listing, one attribute write and a raise run to completion",
	),
	...
	audited("query minimized", interruptRunsOn,
		"one Accessibility listing per application and one line of output; nothing blocks"),
